 ...
 * This file demonstrates how to integrate Yarnkite with a web frontend
 */

// For React/Vue/Angular applications
export class YarnkiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YarnkiteClient(provider, contractAddress);
